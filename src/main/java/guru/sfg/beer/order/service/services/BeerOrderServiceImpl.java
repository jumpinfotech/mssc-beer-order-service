...
public class BeerOrderServiceImpl implements BeerOrderService {
    ...
    public BeerOrderDto placeOrder(UUID customerId, BeerOrderDto beerOrderDto) {
        ...
        if (customerOptional.isPresent()) {
            ...
            // We've split out the Beer + the Beer inventory implementation > therefore we are no longer handling new order events.   
            // We have to coordinate across the services, hence the TODO. 
            //todo impl
